module.exports = {
	...
	"rules": {
		// ESLINT
		"array-bracket-newline": ["error", "never"], // https://eslint.org/docs/latest/rules/array-bracket-newline
		...
		"brace-style": ["error", "1tbs", { "allowSingleLine": true }], // https://eslint.org/docs/latest/rules/brace-style
    ...
    "no-trailing-spaces": "error", // https://eslint.org/docs/latest/rules/no-trailing-spaces
		...
		"object-curly-newline": ["error", { "multiline": true, "consistent": true }], // https://eslint.org/docs/latest/rules/object-curly-newline
		...
		"operator-linebreak": ["error", "after", { "overrides": { "?": "before", ":": "before", "|>": "before" } }], // https://eslint.org/docs/latest/rules/operator-linebreak
		"padded-blocks": ["error", { "blocks": "never", "switches": "never", "classes": "never" }], // https://eslint.org/docs/latest/rules/padded-blocks
    ...
    "@typescript-eslint/no-unnecessary-type-arguments": "warn", // https://typescript-eslint.io/rules/no-unnecessary-type-arguments/
		...
		"vue/brace-style": ["error", "1tbs", { "allowSingleLine": true }], // https://eslint.vuejs.org/rules/brace-style.html
		...
		"vue/object-curly-newline": ["error", { "multiline": true, "consistent": true }], // https://eslint.vuejs.org/rules/object-curly-newline.html
		...
		"vue/operator-linebreak": ["error", "after", { "overrides": { "?": "before", ":": "before", "|>": "before" } }], // https://eslint.vuejs.org/rules/operator-linebreak.html
